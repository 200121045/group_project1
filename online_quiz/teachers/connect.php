...
<head>
  ...
  <?php
$con = mysqli_connect("localhost" , "root" ,"" ,"teacher_db"  );
if(isset($_POST['subm']))
{
...
$query = "INSERT INTO tech_data (user_id, uname, psame,cpsame,clg, email,subject_id) VALUES ('$user_id',$fname', '$pass', '$cpass',$colg, '$email' ,'$subject_id')";
...
<body>
		<div class="form-box">
            ...
            <input type="number" class="input-field"name="user_id" placeholder="userID" required="required">
